...
[![HACS Installs](https://img.shields.io/badge/dynamic/json?
  color=41BDF5
  &logo=home-assistant
  &label=HACS%20installs
  &cacheSeconds=86400
  &url=https://analytics.home-assistant.io/custom_integrations.json
  &query=$.volcano_integration.total
)](https://github.com/hacs/default/tree/main/integration/Chuffnugget-volcano_integration)
